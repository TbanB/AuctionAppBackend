...
public class AuthFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
	    ...
	    // Permitir solicitudes de GET a /auctions y /auctions/category/{id} sin autenticación
	    ...
	    // Permitir solicitudes de GET a /categories y /auctions/categories sin autenticación
	    ...
	    if (token != null && token.startsWith("Bearer ")) {
	        ...
	        try {
	            ...
	            if (userId > -1 && validateToken) {
	                ...
	                loginDao.revokeAllUserToken(userId);
